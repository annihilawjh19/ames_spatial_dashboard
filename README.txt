...
-   Server-side filtering by neighborhood, price, year built, and
    overall quality
...
-   The model uses a random forest regressor for prediction and a linear
    regression benchmark.
-   Clusters are computed from selected numeric and spatial variables.
-   The dataset does not include polygon neighborhood boundaries, so the
    dashboard uses point-level coordinates.
